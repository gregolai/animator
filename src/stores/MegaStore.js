...
class Provider extends React.Component {
  ...
  createAnimation = () => { throw 'not implemented'; };
  getAnimation = (animationId) => { throw 'not implemented'; };
  getAnimations = () => { throw 'not implemented'; };
  ...
  deleteAnimation = (animationId) => {
    ...
    new DeleteCommand(
      () => {
        ...
        const { list: tweens, items: deletedTweens } = this._deleteTweens(t => t.animId === animationId);
        const { list: keyframes, items: deletedKeyframes } = this._deleteKeyframes(kf => kf.animId === animationId);
  ...
  createTween = (animId, definitionId) => { throw 'not implemented'; }
  getTween = (tweenId) => { throw 'not implemented'; };
  getTweens = (animationId) => { throw 'not implemented'; };
  ...
  deleteTween = (tweenId) => { throw 'not implemented'; };

  createKeyframe = (tweenId) => { throw 'not implemented'; };
  getKeyframe = (keyframeId) => { throw 'not implemented'; };
  getKeyframes = (tweenId) => { throw 'not implemented'; };
  ...
  deleteKeyframe = (keyframeId) => { throw 'not implemented'; };

  createInstance = (animationId) => { throw 'not implemented'; };
  getInstance = (instanceId) => { throw 'not implemented'; };
  getInstances = instanceIds => {
    return db.getMany(this.state.instances, instanceIds).items;
  };
  deleteInstance = (instanceId) => { throw 'not implemented'; };
